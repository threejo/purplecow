...
<body>
										...
										<nav>
											...
											<!-- 여기가 네비 바 링크,  -->
												...
												<li><a href="reservation.jsp">예약하기</a>
													<ul class="submenu">
														<li><a href="/">왕복 예약</a></li>
														<li><a href="/">편도 예약</a></li>
														<li><a href="/">부름예약</a></li>
													</ul></li>
	...
	<main>
		<!-- Slider Area Start-->
		<!-- 여기가 헤더? 그 위에 보라색 부분이에요 여기에 작성한게 그쪽에 나옵니다. -->
		...
		<!--? Start Button -->
		<!-- 여기가 아래 하얀색 부분이에요 여기에 페이지 내용 작성하시면 됩니다. -->
