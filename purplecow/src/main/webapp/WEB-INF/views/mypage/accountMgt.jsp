...
<body>
	...
	<main>
					...
					<div class="row align-items-center justify-content-center">
						<div class="col-xl-8 col-lg-9 col-md-12 ">
							<div class="hero__caption hero__caption3 text-center">
								<h1 data-animation="fadeInLeft" data-delay=".6s ">계정 관리</h1>
							</div>
						</div>
					</div>
				</div>
		...
		<section class="button-area">
			<div class="container box_1170 border-top-generic col-lg-3 offset-lg-1">
				...
				<div style="margin: 20px 350px 20px 350px;">
					<button class="button rounded-0 primary-bg text-white w-100 btn_1 boxed-btn" id="modal_btn" style="font-size: 120%;" type="submit">수정하기</button>
					<!-- 모달 시작 -->
					<div class="black_bg"></div>
					<div class="modal_wrap" style="background-color: #fbf9ff; border-radius: 20px;">
						<div class="modal_close">
							<a href="#">close</a>
						</div>
						<div style="display: flex; align-items: center; flex-direction: row; justify-content: center;">
							<div style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%);font-size: 150%;color:#ef67ff;">
								비밀번호 확인</div>
