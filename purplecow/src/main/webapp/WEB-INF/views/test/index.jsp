                        ...
                        <div class="row align-items-center justify-content-between">
                            <div class="col-xl-5 col-lg-5 col-md-9 ">
                                <div class="hero__caption">
                                    <span data-animation="fadeInLeft" data-delay=".3s">Purple Cow</span>
                                    <h1 data-animation="fadeInLeft" data-delay=".6s ">Drive Always!   </h1>
                                    <p data-animation="fadeInLeft" data-delay=".8s">집이랑 가까운 곳에서 편하게 빌리세요
                                   </p>
                                    <!-- Slider btn -->
                            ...
                            <div class="col-xl-6 col-lg-6">
                                <div class="hero__img d-none d-lg-block f-right">
                                    <img src="../../res/assets/img/cow.png" alt="" data-animation="fadeInRight" data-delay="1s">
                                </div>
                            </div>
                        </div>
                    </div>
