...
<link rel="stylesheet"
   href="../../res/assets/css/progressbar_barfiller.css">
...
<body>
      ...
      <div class="login-form">
         ...
         <div class="logo-login">
            <a href="index.html"><img
               src="../../res/assets/img/logo/cow_loader.png" alt=""></a>
         </div>
         <h2>Login Here</h2>
         ...
         <div>
            <div style="margin: 30px 0px">
               <button id="login_btn" class="btn w-100">L O G I N</button>
            </div>
         </div>
         <a
            href="https://kauth.kakao.com/oauth/authorize?client_id=키넣어야함&redirect_uri=http://localhost:8088/kakaologin&response_type=code">카카오
            로그인</a>
         <!-- Forget Password -->
   ...
   <script src="./../../res/assets/js/login.js"></script>
