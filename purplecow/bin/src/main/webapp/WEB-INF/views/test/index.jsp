                    ...
                    <div class="container-fluid">
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-2 col-lg-2">
                                <div class="logo">
                                    <a href="index.html"><img src="../../res/assets/img/logo/logo.png" alt=""></a>
                                </div>
                            </div>
    ...
    <main>
        ...
        <div class="slider-area slider-bg ">
                        ...
                        <div class="row align-items-center justify-content-between">
                            <div class="col-xl-5 col-lg-5 col-md-9 ">
                                <div class="hero__caption">
                                    <span data-animation="fadeInLeft" data-delay=".3s">퍼플 카우 짱!</span>
                                    <h1 data-animation="fadeInLeft" data-delay=".6s ">Powerful web hosting</h1>
                                    <p data-animation="fadeInLeft" data-delay=".8s">퍼플 카우는 차량 공유 플랫폼이랍니다~~~~~~~
                                   </p>
                                    <!-- Slider btn -->
                            ...
                            <div class="col-xl-6 col-lg-6">
                                <div class="hero__img d-none d-lg-block f-right">
                                    <img src="../../res/assets/img/hero/hero_right.png" alt="" data-animation="fadeInRight" data-delay="1s">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="slider-shape d-none d-lg-block">
                <img class="slider-shape1" src="../../res/assets/img/hero/top-left-shape.png" alt="">
            </div>
        </div>
        <!-- Slider Area End -->
        <!-- Domain-search start -->
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-6"">
                    <div class="single-cat">
                        <div class="cat-icon">
                            <img src="../../res/assets/img/icon/services1.svg" alt="">
                        </div>
                        <div class="cat-cap">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="single-cat">
                        <div class="cat-icon">
                            <img src="../../res/assets/img/icon/services2.svg" alt="">
                        </div>
                        <div class="cat-cap">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="single-cat">
                        <div class="cat-icon">
                            <img src="../../res/assets/img/icon/services3.svg" alt="">
                        </div>
                        <div class="cat-cap">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="single-cat">
                        <div class="cat-icon">
                            <img src="../../res/assets/img/icon/services5.svg" alt="">
                        </div>
                        <div class="cat-cap">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="single-cat">
                        <div class="cat-icon">
                            <img src="../../res/assets/img/icon/services6.svg" alt="">
                        </div>
                        <div class="cat-cap">
        ...
        <div class="container">
            <div class="row align-items-center justify-content-between">
                <div class="col-xl-5 col-lg-5 col-md-8 col-sm-10">
                    <!-- about-img -->
                    <div class="about-img ">
                        <img src="../../res/assets/img/gallery/about1.png" alt="">
                    </div>
                </div>
                <div class="col-xl-7 col-lg-7 col-md-12">
                    <div class="about-caption ">
                        ...
                        <ul>
                            <li>
                                <img src="../../res/assets/img/icon/right.svg" alt="">
        ...
        <div class="container">
            <div class="row align-items-center justify-content-between">
                ...
                <div class="col-xl-5 col-lg-5 col-md-8 col-sm-10">
                    <!-- about-img -->
                    <div class="about-img ">
                        <img src="../../res/assets/img/gallery/about2.png" alt="">
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="h1-testimonial-active">
                            ...
                            <div class="single-testimonial text-center mt-55">
                                <div class="testimonial-caption">
                                    <img src="../../res/assets/img/icon/quotes-sign.png" alt="" class="quotes-sign">
                                ...
                                <div class="testimonial-founder d-flex align-items-center justify-content-center">
                                    <div class="founder-img">
                                        <img src="../../res/assets/img/icon/testimonial.png" alt="">
                                    </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                        <div class="single-footer-caption mb-50">
                            ...
                            <div class="footer-logo mb-25">
                                <a href="index.html"><img src="../../res/assets/img/logo/logo2_footer.png" alt=""></a>
                            </div>
